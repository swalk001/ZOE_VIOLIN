    ...
    return (
        <div className="song-list">
            ...
            <ul>
                ...
                <li>
                    Allegro, “Spring” from the Four Seasons <small>by</small> A.
                    Vivaldi{' '}
                </li>
                <li>
                    Arrival of the Queen of Sheba <small>by</small> G.F. Handel
                </li>
                <li>
                ...
                <li>
                    Bridal Chorus (from Lohengrin) <small>by</small> Richard
                    Wagner{' '}
                </li>
                <li>
                ...
                <li>
                    Hornpipe from “Water Music” <small>by</small> G.F. Handel
                </li>
                <li>
                    Humoresque <small>by</small> A. Dvorak
                </li>
                <li>
                    Jeus’, Joy of Man’s Desiring <small>by</small> J.S. Bach
                </li>
                <li>
                    La Rejouissance from “Royal Fireworks <small>by</small> G.F.
                    Handel
                </li>
                <li>
                    Largo, “Winter” from the Four Seasons <small>by</small> A.
                    Vivaldi
                </li>
                <li>
                    Méditation (Thaïs) <small>by</small> Jules Massenet
                </li>
                <li>
                    Minuet <small>by</small> J.S. Bach
                </li>
                <li>
                    Minuet in G <small>by</small> Ludwig van Beethoven
                </li>
                <li>
                    Ode to Joy <small>by</small> Ludwig van Beethoven
                </li>
                <li>
                    Rondeau from “Masterpiece Theater” <small>by</small>{' '}
                    Jean-Joseph Mouret
                </li>
                <li>
                ...
                <li>
                    Trumpet Voluntary in D Major <small>by</small> Jeremiah
                    Clarke
                </li>
                <li>
                    {' '}
            ...
            <ul>
                <li>
                    {' '}
                    A Thousand Years <small>by</small> Christina Perri{' '}
                </li>
                <li>
                    Ain’t No Sunshine <small>by</small> Bill Withers{' '}
                </li>
                <li>All I Ask of You from “Phantom of the Opera”</li>
                <li>
                ...
                <li>
                    All You Need is Love <small>by</small> The Beatles{' '}
                </li>
                <li>
                ...
                <li>
                    Best Day of My Life <small>by</small> American Authors{' '}
                </li>
                <li>
                ...
                <li>
                    Can’t Help Falling in Love <small>by</small> Elvis Presley{' '}
                </li>
                <li>
                    Can You Feel the Love Tonight <small>by</small> Elton John
                </li>
                ...
                <li>For the Love of a Princess Theme from Braveheart </li>
                <li>
                ...
                <li>
                    I Only Want to be With You <small>by</small> Dusty
                    Springfield{' '}
                </li>
                <li>Let’s Stay Together - AL Green</li>
                <li>
                    Love me Like You Do <small>by</small> Ellie Goulding
                </li>
                <li>
                ...
                <li>
                    Somewhere Over the Rainbow <small>by</small> Harold Arlen
                </li>
                <li>
                    Stand <small>by</small> Me <small>by</small> Ben E. King{' '}
                </li>
                <li>
                    Sweet Caroline <small>by</small> Neil Diamond
                </li>
                <li>
                    This Will Be (an Everlasting Love) <small>by</small> Natalie
                    Cole{' '}
                </li>
                <li>
                ...
                <li>
                    What a Wonderful World <small>by</small> Louis Armstrong
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    It Don’t Mean a Thing (if you ain’t got that swing) by Duke
                    Ellington{' '}
                </li>
                <li>Meditation by Antonio Carlos Jobim </li>
                <li>Quiet Nights of Quiet Stars by Antonio Carlos Jobim </li>
                <li>Summertime by George Gershwin </li>
                <li>That’s Amore by Warren/Brooks </li>
                <li>When You Wish Upon A Star by Harline/Washington</li>
                <li> + many more!</li>
            </ul>
        </div>
    );
