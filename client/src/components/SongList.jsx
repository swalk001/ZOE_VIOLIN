...
const SongList = () => {
    return (
        <div>
            <div className="song-list-img"></div>
            <div className="song-list-img2"></div>
            <div className="song-list">
                ...
                <ul>
                    ...
                    <li>
                        Arrival of the Queen of Sheba <small>by</small> G.F.
                        Handel
                    </li>
                    <li>
                    ...
                    <li>
                        Hornpipe from “Water Music” <small>by</small> G.F.
                        Handel
                    </li>
                    <li>
                    ...
                    <li>
                        La Rejouissance from “Royal Fireworks <small>by</small>{' '}
                        G.F. Handel
                    </li>
                    <li>
                        Largo, “Winter” from the Four Seasons <small>by</small>{' '}
                        A. Vivaldi
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        Can’t Help Falling in Love <small>by</small> Elvis
                        Presley{' '}
                    </li>
                    <li>
                        Can You Feel the Love Tonight <small>by</small> Elton
                        John
                    </li>
                    ...
                    <li>
                        Somewhere Over the Rainbow <small>by</small> Harold
                        Arlen
                    </li>
                    <li>
                    ...
                    <li>
                        This Will Be (an Everlasting Love) <small>by</small>{' '}
                        Natalie Cole{' '}
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        It Don’t Mean a Thing (if you ain’t got that swing) by
                        Duke Ellington{' '}
                    </li>
