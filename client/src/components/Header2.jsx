            ...
            <div className="header">
                <div className="header__links">
                    <div className="header__badge-container">
                        <div className="header__badge header__badge--insta">
                            <svg
                    ...
                    <div className="header__badge-container">
                        <div className=" header__badge header__badge--tube">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                                onClick={() =>
                ...
                <div
                    className="header__music-player"
                    onClick={(e) => toggleMusic()}
                >
                    <div className="header__music-player-badges">
                        <div className="header__music-player-badges--1">
                            <ion-icon name="musical-note"></ion-icon>
                        </div>
                        <div className="header__music-player-badges--2">
                            <ion-icon name="musical-notes"></ion-icon>
                        </div>
                        <div className="header__music-player-badges--3">
                            <ion-icon name="musical-note"></ion-icon>
                        </div>
                    </div>
                </div>
